...
def mi3(embeddings_dictionary,connectors_dic,a,N):# формула "MI в кубе", используемая в НКРЯ для ранжирования
...
def mi3_exp(embeddings_dictionary,connectors_dic,a,N): #Вариант предыдущей формулы, адаптированной для словосочетаний разной длины
